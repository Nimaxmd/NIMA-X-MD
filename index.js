...
console.log("CONNECTING NIMA-X-MD BOT 🎭...");
...
console.log('HASHAN MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *𝗡𝗜𝗠𝗔-𝗫-𝗠𝗗 Cᴏɴɴᴇᴄᴛᴇᴅ Sᴜᴄᴄᴇssғᴜʟʏ Tʏᴘᴇ .Mᴇɴᴜ Tᴏ Gᴇᴛ Cᴏᴍᴍᴀɴᴅ Lɪsᴛ Cʀᴇᴀᴛᴇᴅ Bʏ ᴀᴡᴀɪs ᴍᴅ*

> *Jᴏɪɴ Oᴜʀ Wʜᴀᴛsᴀᴘᴘ Cʜᴀɴɴᴇʟ Fᴏʀ Uᴘᴅᴀᴛᴇs Oꜰ 𝗡𝗜𝗠𝗔-𝗫-𝗠𝗗*

*https://whatsapp.com/channel/0029Vb1o91L72WTvgO0aay0e*

> *Fᴏʟʟᴏᴡ Uꜱ Oɴ  𝙼𝚈 𝚠𝚎𝚋*

*https://rcd-github-real.github.io/dark-nima/*

*╭⊱✫ NIMA-X-MD ✫⊱╮*
*│✫➠ - 📂REPOSITORY NAME:* *NIMA-X-MD*
*│✫➠ - 📃DESCRIPTION:* *SRILANKA BEST BOT*
*│✫➠ - 🛡️OWNER:* *NIMNA DULSHAN*
*│✫➠ - 🌐URL:* *https://github.com/HASHAN_MD_BOT_V1*
...
//================ownerreact
if(senderNumber.includes("94740250759")){
if(isReact) return
m.react("👑")
}
